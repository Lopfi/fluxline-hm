...
This template was based on the [scribbling-hm](https://github.com/fine-seat/hm-typst-template) by @fine-seat.
Thank you for creating this amazing template!

## Installation

You can use this template in the Typst web app by clicking "Start from template" on the dashboard and searching for `fluxline-hm`.

Alternatively, you can use the CLI to initialize this project using the command:

```bash
typst init @preview/fluxline-hm
```
